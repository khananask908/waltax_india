...
const testimonials = [
  {
    ...
    content: 'WalTax India made the process of incorporating my tech startup incredibly smooth. Their team guided me through each step and helped me understand the compliance requirements.',
    rating: 5,
  },
  {
    id: 2,
    ...
    content: 'As a first-time entrepreneur, I had many questions about business registration. The team at WalTax India was patient, knowledgeable, and made the process stress-free.',
    rating: 5,
  },
  {
    id: 3,
    ...
    content: 'We\'ve been using WalTax India for all our compliance and tax filing needs for over 3 years. Their expertise and prompt service has saved us time and resources.',
    rating: 4,
  },
];
      ...
      <Container>
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Join thousands of satisfied business owners who trust WalTax India
          </p>
        </div>
